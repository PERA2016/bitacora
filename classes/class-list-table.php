...
*Dirección física: /BICOCI-bitacora/classes/class-list-table.php
*/
namespace WP_Stream;
...
class List_Table extends \WP_List_Table {
	...
	function no_items() {
		...
		<div class="stream-list-table-no-items">
			<p><?php esc_html_e( 'No se ha hecho ninguna acción en BICOCI.', 'stream' ) ?></p>
		</div>
		<?php
	}
	...
	function get_columns() {
		...
		return apply_filters(
			...
			array(
				...
				'context' => __( 'Ubicación BICOCI', 'stream' ),
